...
def main(args=None):
	...
	args_dict = vars(args)
	cranberry_main = cranberry.Cranberry(args_dict['output_directory'], args_dict['source_file'], args_dict['verbose'], args_dict['quiet'], args_dict['append_audio'], args_dict['request_delay_time'])
	cranberry_main.run()
